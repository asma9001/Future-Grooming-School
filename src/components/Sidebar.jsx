...
export default function Sidebar({ isOpen = true }) {
  ...
  return (
    <aside className="w-full h-full bg-slate-700 text-white flex flex-col p-4">
      {/* Logo Section */}
                  ...
                  >
                    {item.subItems.map((sub, subIndex) => (
                      <div
                        ...
                        className={`flex space-x-4 py-2 rounded cursor-pointer hover:bg-slate-600 ${
                          isActive(sub.path) ? "bg-slate-600" : ""
                        }`}
                      >
