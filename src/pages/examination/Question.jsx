...
export default function Question() {
  ...
  const [questions, setQuestions] = useState([
    {
      ...
      chapter: "Introduction to Alphabets",
    ...
    if (searchTerm) {
      ...
      if (searchColumn === "all") {
        results = results.filter(
          (question) =>
            question.class.toLowerCase().includes(searchValue) ||
            question.course.toLowerCase().includes(searchValue) ||
            question.chapter.toLowerCase().includes(searchValue) ||
            question.type.toLowerCase().includes(searchValue) ||
            question.question.toLowerCase().includes(searchValue) ||
            question.answer.toLowerCase().includes(searchValue) ||
            question.marks.toString().includes(searchValue) ||
            question.seconds.toString().includes(searchValue),
        )
      } else {
        results = results.filter((question) => {
          const fieldValue = question[searchColumn]
  ...
  }, [searchTerm, questions, searchColumn])
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-vertical"
              />
            </div>
            <div>
                ...
                {filteredQuestions.length > 0 ? (
                  filteredQuestions.map((question) => (
                    <tr key={question.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-3 text-sm text-gray-700 max-w-32 truncate">{question.class}</td>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">{question.type}</td>
