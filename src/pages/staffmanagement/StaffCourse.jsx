...
export default function StaffCourses() {
  ...
  const teacherOptions = ["NOUR YOUSEF", "AHMED KHAN", "FATIMA ALI", "MUHAMMAD HASSAN", "AYESHA MALIK"]
  ...
  const handleSubmit = (e) => {
    ...
    const newCourse = {
      id: courseData.length > 0 ? Math.max(...courseData.map((course) => course.id)) + 1 : 1,
      ...
      <div className="p-6 bg-gray-100">
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Credit Hours (CH):</label>
              <input
                type="number"
                name="creditHours"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Contact Hours (COH):</label>
              <input
                type="number"
                name="contactHours"
        ...
        <div className="mt-8">
          <div className="mb-4">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Course Assignments</h2>
            <p className="text-gray-600">Manage staff course assignments and teaching schedules</p>
          </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredCourses.map((course) => (
                    <tr key={course.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{course.departments}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{course.class}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{course.classYear}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{course.section}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{course.course}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{course.ch}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{course.coh}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{course.teacher}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{course.user}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{course.campus}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
