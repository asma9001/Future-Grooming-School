...
const AdmissionYear = () => {
  ...
  const filteredData = admissionData.filter((item) => {
    ...
    switch (filterColumn) {
      case "admissionYear":
        return item.admissionYear.toLowerCase().includes(searchLower)
      case "students":
        return item.students.toString().includes(searchTerm)
      default:
        return item.admissionYear.toLowerCase().includes(searchLower) || item.students.toString().includes(searchTerm)
    }
  })
